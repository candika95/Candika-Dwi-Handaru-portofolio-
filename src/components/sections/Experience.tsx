...
const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{ y: -5 }}
        className={`order-1 bg-white dark:bg-zinc-800 rounded-lg shadow-md w-5/12 px-6 py-4`}
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="relative wrap overflow-hidden p-4">
            <div className="absolute h-full border-2 border-blue-200 dark:border-blue-900/30 left-1/2 transform -translate-x-1/2"></div>
        ...
        <div>
          ...
          <div className="relative wrap overflow-hidden p-4">
            <div className="absolute h-full border-2 border-purple-200 dark:border-purple-900/30 left-1/2 transform -translate-x-1/2"></div>
